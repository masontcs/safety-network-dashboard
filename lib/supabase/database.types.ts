...
export type Database = {
  public: {
    Tables: {
      ...
      cmr_daily_ledger: {
        Row: { id: string; ledger_date: string; period: CmrLedgerPeriod; beginning_cash_cents: number; created_by: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; ledger_date: string; period: CmrLedgerPeriod; beginning_cash_cents?: number; created_by?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; ledger_date?: string; period?: CmrLedgerPeriod; beginning_cash_cents?: number; created_by?: string | null; created_at?: string; updated_at?: string }
        Relationships: []
      }
      cmr_ledger_adjustments: {
        Row: { id: string; daily_ledger_id: string; description: string; amount_cents: number; note: string | null; warn_note: string | null; kind: 'manual' | 'pending_rollup'; sort_order: number; created_by: string | null; created_at: string }
        Insert: { id?: string; daily_ledger_id: string; description: string; amount_cents: number; note?: string | null; warn_note?: string | null; kind?: 'manual' | 'pending_rollup'; sort_order?: number; created_by?: string | null; created_at?: string }
        Update: { id?: string; daily_ledger_id?: string; description?: string; amount_cents?: number; note?: string | null; warn_note?: string | null; kind?: 'manual' | 'pending_rollup'; sort_order?: number; created_by?: string | null; created_at?: string }
        Relationships: []
      }
      cmr_pending_items: {
      ...
      cmr_ap_imports: {
        Row: { id: string; account_id: string; source_filename: string | null; report_total_cents: number | null; payable_total_cents: number | null; line_count: number; imported_by: string | null; imported_at: string; is_current: boolean }
        Insert: { id?: string; account_id: string; source_filename?: string | null; report_total_cents?: number | null; payable_total_cents?: number | null; line_count?: number; imported_by?: string | null; imported_at?: string; is_current?: boolean }
        Update: { id?: string; account_id?: string; source_filename?: string | null; report_total_cents?: number | null; payable_total_cents?: number | null; line_count?: number; imported_by?: string | null; imported_at?: string; is_current?: boolean }
        Relationships: []
      }
      cmr_ap_lines: {
      ...
      billing_profiles: {
        Row: { id: string; customer_id: string; branch_id: string; code: string; name: string; payment_term_id: string | null; rental_minimum_enabled: boolean; rental_minimum_cents: number; field_rules: Json; portal_enabled: boolean; is_active: boolean; status: string; created_at: string; updated_at: string }
        Insert: { id?: string; customer_id: string; branch_id: string; code: string; name: string; payment_term_id?: string | null; rental_minimum_enabled?: boolean; rental_minimum_cents?: number; field_rules?: Json; portal_enabled?: boolean; is_active?: boolean; status?: string }
        Update: { id?: string; customer_id?: string; branch_id?: string; code?: string; name?: string; payment_term_id?: string | null; rental_minimum_enabled?: boolean; rental_minimum_cents?: number; field_rules?: Json; portal_enabled?: boolean; is_active?: boolean; status?: string }
        Relationships: []
      }
      ...
      billing_invoices: {
        Row: { id: string; invoice_number: string; job_id: string; profile_id: string; entity_id: string; branch_id: string; through_date: string; invoice_date: string; status: BillingInvoiceStatus; tax_rate_pct: number; rental_subtotal_cents: number; sales_subtotal_cents: number; other_subtotal_cents: number; rental_minimum_adjustment_cents: number; subtotal_cents: number; taxable_base_cents: number; tax_cents: number; total_cents: number; qb_exported_at: string | null; qb_exported_by: string | null; created_by: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; invoice_number: string; job_id: string; profile_id: string; entity_id: string; branch_id: string; through_date: string; invoice_date?: string; status?: BillingInvoiceStatus; tax_rate_pct?: number; rental_subtotal_cents?: number; sales_subtotal_cents?: number; other_subtotal_cents?: number; rental_minimum_adjustment_cents?: number; subtotal_cents?: number; taxable_base_cents?: number; tax_cents?: number; total_cents?: number; qb_exported_at?: string | null; qb_exported_by?: string | null; created_by?: string | null }
        Update: { id?: string; invoice_number?: string; invoice_date?: string; through_date?: string; status?: BillingInvoiceStatus; tax_rate_pct?: number; rental_subtotal_cents?: number; sales_subtotal_cents?: number; other_subtotal_cents?: number; rental_minimum_adjustment_cents?: number; subtotal_cents?: number; taxable_base_cents?: number; tax_cents?: number; total_cents?: number; qb_exported_at?: string | null; qb_exported_by?: string | null }
        Relationships: []
      }
      billing_invoice_lines: {
        Row: { id: string; invoice_id: string; ticket_id: string | null; source_line_id: string | null; kind: BillingInvoiceLineKind; item_id: string | null; variation_id: string | null; description: string; lot_date: string | null; qty: number; units: number; unit_rate_cents: number; amount_cents: number; taxable: boolean; rental_item_qty: number | null; rental_days: number | null; period_end: string | null; created_at: string }
        Insert: { id?: string; invoice_id: string; ticket_id?: string | null; source_line_id?: string | null; kind: BillingInvoiceLineKind; item_id?: string | null; variation_id?: string | null; description: string; lot_date?: string | null; qty?: number; units?: number; unit_rate_cents: number; amount_cents: number; taxable?: boolean; rental_item_qty?: number | null; rental_days?: number | null; period_end?: string | null }
        Update: { id?: string; invoice_id?: string; ticket_id?: string | null; source_line_id?: string | null; kind?: BillingInvoiceLineKind; item_id?: string | null; variation_id?: string | null; description?: string; lot_date?: string | null; qty?: number; units?: number; unit_rate_cents?: number; amount_cents?: number; taxable?: boolean; rental_item_qty?: number | null; rental_days?: number | null; period_end?: string | null }
        Relationships: []
      }
      billing_qb_export_config: {
        Row: { id: number; ar_account: string; tax_account: string; tax_zero_memo: string; tax_extra: string; default_net_days: number; name_includes_job: boolean; kind_map: Json; branch_class: Json; updated_at: string }
        Insert: { id?: number; ar_account?: string; tax_account?: string; tax_zero_memo?: string; tax_extra?: string; default_net_days?: number; name_includes_job?: boolean; kind_map?: Json; branch_class?: Json; updated_at?: string }
        Update: { id?: number; ar_account?: string; tax_account?: string; tax_zero_memo?: string; tax_extra?: string; default_net_days?: number; name_includes_job?: boolean; kind_map?: Json; branch_class?: Json; updated_at?: string }
        Relationships: []
      }
      billing_quotes: {
        Row: { id: string; quote_number: string; profile_id: string | null; entity_id: string; branch_id: string; status: BillingQuoteStatus; quote_date: string; job_name: string | null; notes: string | null; tax_rate_pct: number; subtotal_cents: number; tax_cents: number; total_cents: number; converted_job_id: string | null; prospect_company: string | null; prospect_contact_name: string | null; prospect_contact_email: string | null; prospect_contact_phone: string | null; prospect_price_list_id: string | null; prospect_tier_id: string | null; converted_customer_id: string | null; converted_profile_id: string | null; created_by: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; quote_number: string; profile_id?: string | null; entity_id: string; branch_id: string; status?: BillingQuoteStatus; quote_date?: string; job_name?: string | null; notes?: string | null; tax_rate_pct?: number; subtotal_cents?: number; tax_cents?: number; total_cents?: number; converted_job_id?: string | null; prospect_company?: string | null; prospect_contact_name?: string | null; prospect_contact_email?: string | null; prospect_contact_phone?: string | null; prospect_price_list_id?: string | null; prospect_tier_id?: string | null; converted_customer_id?: string | null; converted_profile_id?: string | null; created_by?: string | null }
        Update: { id?: string; quote_number?: string; profile_id?: string | null; entity_id?: string; branch_id?: string; status?: BillingQuoteStatus; quote_date?: string; job_name?: string | null; notes?: string | null; tax_rate_pct?: number; subtotal_cents?: number; tax_cents?: number; total_cents?: number; converted_job_id?: string | null; prospect_company?: string | null; prospect_contact_name?: string | null; prospect_contact_email?: string | null; prospect_contact_phone?: string | null; prospect_price_list_id?: string | null; prospect_tier_id?: string | null; converted_customer_id?: string | null; converted_profile_id?: string | null; updated_at?: string }
        Relationships: []
      }
      billing_quote_lines: {
