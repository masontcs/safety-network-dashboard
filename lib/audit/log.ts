...
export type AuditAction =
  ...
  | 'wh.ar.import'
  | 'wh.ap.import'
  // Western Highways payroll — periods ACCUMULATE, so this entry records whether an upload
  // added a pay period or overwrote one that was already stored (metadata.replaced).
  | 'wh.payroll.import'
